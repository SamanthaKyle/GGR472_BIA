...
greenp = gpd.read_file("data/greenP_cleaned/greenp_beaches.geojson")
bikeshare = gpd.read_file("data/bikeshare_cleaned/bikeshare_beaches.geojson")
...
#bikeshare_cleaned.to_file("data/bikeshare_cleaned/bikeshare_cleaned.geojson", driver="GeoJSON")
#greenp_cleaned.to_file("data/greenP_cleaned/greenp_cleaned.geojson", driver="GeoJSON")